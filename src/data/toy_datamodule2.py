...
class ToyDataset(Dataset):
    ...
    def __init__(self, target_fn: Callable[[Tensor], Tensor], input_fn: Callable[[Tensor], Tensor], latent_fn, num_samples=10000, width=8, height=8):
        self.width = width
        self.height = height
        #torch.randint(0, 2, (num_samples, self.width, self.height))
        self.latents=latent_fn()
        self.inputs = input_fn(self.latents)
